...
export const METROS: MetroDef[] = [
  ...
  { metro: 'Hartford', state: 'CT', zip3: ['060','061','062'], cities: ['hartford','west hartford','east hartford','new britain'] },
  { metro: 'New Haven', state: 'CT', zip3: ['064','065'], cities: ['new haven','waterbury','meriden'] },
  // ---- New England ----
  {
    metro: 'Boston',
    state: 'MA',
  ...
  { metro: 'Worcester', state: 'MA', zip3: ['015','016','017'], cities: ['worcester','framingham'] },
  { metro: 'Providence', state: 'RI', zip3: ['028','029'], cities: ['providence','cranston','warwick','pawtucket','woonsocket'] },
  // ---- DC / Mid-Atlantic ----
  {
    metro: 'Washington',
    state: 'DC',
  ...
  { metro: 'Baltimore', state: 'MD', zip3: ['210','211','212','214'], cities: ['baltimore','columbia','towson','dundalk','annapolis'] },
  { metro: 'Richmond', state: 'VA', zip3: ['232'], cities: ['richmond','henrico','chesterfield'] },
  { metro: 'Hampton Roads', state: 'VA', zip3: ['233','234','235'], cities: ['norfolk','virginia beach','chesapeake','newport news','hampton','portsmouth','suffolk'] },
  // ---- Midwest ----
  {
    metro: 'Chicago',
    state: 'IL',
  ...
  { metro: 'Nashville', state: 'TN', zip3: ['370','371','372'], cities: ['nashville','murfreesboro','franklin','hendersonville','smyrna','antioch'] },
  { metro: 'Memphis', state: 'TN', zip3: ['380','381'], cities: ['memphis','germantown','bartlett','collierville'] },
  { metro: 'Knoxville', state: 'TN', zip3: ['377','378','379'], cities: ['knoxville','maryville','oak ridge'] },
  { metro: 'Chattanooga', state: 'TN', zip3: ['373','374'], cities: ['chattanooga','cleveland'] },
  // ---- Texas ----
  {
  ...
  { metro: 'San Antonio', state: 'TX', zip3: ['780','781','782'], cities: ['san antonio','new braunfels','schertz','converse'] },
  { metro: 'Austin', state: 'TX', zip3: ['786','787'], cities: ['austin','round rock','cedar park','georgetown','san marcos','pflugerville','leander','kyle'] },
  { metro: 'El Paso', state: 'TX', zip3: ['798','799','885'], cities: ['el paso','socorro','horizon city'] },
  { metro: 'Rio Grande Valley', state: 'TX', zip3: ['785'], cities: ['mcallen','brownsville','edinburg','harlingen','pharr','mission','weslaco','san juan'] },
  { metro: 'Corpus Christi', state: 'TX', zip3: ['783','784'], cities: ['corpus christi','portland','kingsville'] },
  // ---- Florida ----
  {
    metro: 'Miami',
    state: 'FL',
  ...
  { metro: 'West Palm Beach', state: 'FL', zip3: ['334'], cities: ['west palm beach','boca raton','boynton beach','delray beach','jupiter','wellington'] },
  { metro: 'Orlando', state: 'FL', zip3: ['327','328','329','347'], cities: ['orlando','kissimmee','sanford','winter park','apopka','altamonte springs','oviedo'] },
  { metro: 'Tampa', state: 'FL', zip3: ['335','336','337','346'], cities: ['tampa','saint petersburg','st petersburg','clearwater','brandon','largo','riverview','wesley chapel'] },
  { metro: 'Jacksonville', state: 'FL', zip3: ['320','322'], cities: ['jacksonville','orange park','saint augustine'] },
];
